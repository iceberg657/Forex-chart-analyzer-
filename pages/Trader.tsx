    ...
    <div className="space-y-8">
      ...
      <div className="max-w-4xl mx-auto bg-white/80 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-300 dark:border-gray-700 rounded-lg p-8 space-y-6">
        <div>
          ...
          <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-400 dark:border-gray-600 border-dashed rounded-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label htmlFor="trading-style" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Trading Style</label>
            ...
            <div>
              <label htmlFor="risk-reward" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Risk/Reward Ratio</label>
