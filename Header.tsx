      ...
      <div className="flex items-center justify-between h-16">
        ...
        <div className="hidden md:block">
          <div className="ml-10 flex items-center space-x-4">
            ...
            <NavLink to="/predictor" className={getNavLinkClass}>Catalyst Predictor</NavLink>
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <NavLink to="/predictor" className="block px-3 py-2 rounded-md text-base font-medium text-gray-600 dark:text-gray-300 hover:bg-black/10 dark:hover:bg-white/10">Catalyst Predictor</NavLink>
